...
export default class MathEditor {
	...
	run() {
		...
		mathEditorContainer.className = 'math-editor-container border border-secondary rounded';
		...
		textarea.addEventListener('focus', function(e) {
			mathEditorContainer.className = 'math-editor-container border border-primary rounded';
		});
